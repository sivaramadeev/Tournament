...
import { Tournament, Player, MatchStatus } from '../types';
...
const PlayerView: React.FC<PlayerViewProps> = ({ tournament }) => {
    ...
    return (
        <div className="space-y-8">
            <h1 className="text-4xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">{tournament.settings.name}</h1>
