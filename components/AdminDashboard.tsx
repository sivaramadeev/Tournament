...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ tournament, setTournament }) => {
    ...
    return (
        <div className="space-y-6">
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="border-b border-gray-700 md:border-b-0">
                 ...
                 <div className="relative group">
                    ...
                    >
                        {tournament.status === 'Publishing' ? 'Publishing...' : 'Publish Tournament to Players'}
                    </button>
                    {publishDisabledReason && (
                        <div className="absolute bottom-full mb-2 w-72 p-2 text-sm text-white bg-gray-900 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none">
                            {publishDisabledReason}
                        </div>
                    )}
                </div>
